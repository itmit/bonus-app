...
namespace bonus.app.Core.Services.Implementations
{
	public class StockService : BaseService, IStockService
	{
		...
		public async Task<Stock> Detail(Guid uuid)
		{
			Stock stock = null;
		...
		public async Task<IEnumerable<Stock>> ArchiveStock(Guid? serviceUuid, string city)
		{
			List<Stock> stocks;
		...
		public async Task<List<Stock>> FavoriteStocks()
		{
		...
		public Task<IEnumerable<Stock>> MyArchiveStock() => MyArchiveStock(null, null);

		public async Task<IEnumerable<Stock>> MyArchiveStock(Guid? serviceUuid, string city)
		{
			List<Stock> stocks;
			if (serviceUuid == null && string.IsNullOrEmpty(city))
			{
		...
		public async Task<IEnumerable<Stock>> MyStocks()
		{
		...
		public async Task<Stock> StockForEdit(Guid uuid)
		{

...
namespace bonus.app.Core.Services.Implementations
{
	public class ProfileService : BaseService, IProfileService
	{
		...
		public Task<List<PortfolioImage>> Portfolio() => Portfolio(Guid.Empty);

		public event EventHandler PortfolioChanged;

		public async Task<List<PortfolioImage>> Portfolio(Guid uuid)
		{
		...
		public async Task<User> User(Guid uuid, int? stockId, int? serviceId)
		{
		...
		public Task<User> User(Guid uuid) => User(uuid, null, null);
